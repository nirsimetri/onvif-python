...
- The WSDL files in the [`wsdl/`](https://github.com/nirsimetri/onvif-python/tree/main/onvif/wsdl) folder are distributed under the ONVIF Contributor License Agreement and Apache License 2.0. See [`LICENSE.md`](https://github.com/nirsimetri/onvif-python/tree/main/onvif/wsdl) for details.
