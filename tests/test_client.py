...
class TestONVIFClientServiceDiscovery:
    ...
    def test_get_capabilities_fallback(self, mock_onvif_client, mock_capabilities):
        ...
        client = mock_onvif_client
        client._devicemgmt.GetServices.side_effect = Exception("GetServices not supported")
...
class TestONVIFClientServiceAccess:
    ...
    def test_pullpoint_method_with_subscription_ref(self, mock_onvif_client, sample_subscription_ref):
    ...
    def test_pullpoint_caching_by_xaddr(self, mock_onvif_client, sample_subscription_ref):
...
class TestONVIFClientErrorHandling:
    ...
    def test_service_discovery_failure_handling(self, test_client_params):
        ...
        with patch('onvif.client.Device') as mock_device_class:
            ...
            mock_device.GetCapabilities.side_effect = Exception("GetCapabilities failed")
