...
class TestAppManagementWSDLCompliance:
    ...
    def get_wsdl_operations():
        ...
        ns = {
            ...
            "tam": "http://www.onvif.org/ver10/appmgmt/wsdl",
        }

        operations = {}

        # Find all operations in portType
        port_type = root.find('.//wsdl:portType[@name="AppManagement"]', ns)
    ...
    def get_implemented_methods():
        """Get all implemented methods in AppManagement class."""
        methods = {}
        for name, method in inspect.getmembers(
            AppManagement, predicate=inspect.isfunction
        ):
    ...
    @patch("onvif.services.appmgmt.ONVIFOperator")
    def test_operator_call_usage(self, mock_operator_class):
        ...
        # Create AppManagement instance
        app_management = AppManagement(xaddr="http://test:80/onvif/AppManagement")
        ...
        for method_name, method_info in implemented_methods.items():
            ...
            try:
                # Get the method
                method = getattr(app_management, method_name)
    ...
    def test_specific_methods_implementation(self, mock_operator_class):
        ...
        app_management.GetServiceCapabilities()
        mock_operator_instance.call.assert_called_with("GetServiceCapabilities")

        # Test GetInstalledApps (no parameters)
        mock_operator_instance.call.reset_mock()
        app_management.GetInstalledApps()
        mock_operator_instance.call.assert_called_with("GetInstalledApps")

        # Test GetAppsInfo (optional parameter)
        mock_operator_instance.call.reset_mock()
        app_management.GetAppsInfo(AppID="app123")
        mock_operator_instance.call.assert_called_with("GetAppsInfo", AppID="app123")

        # Test GetAppsInfo without parameter
        mock_operator_instance.call.reset_mock()
        app_management.GetAppsInfo()
        mock_operator_instance.call.assert_called_with("GetAppsInfo", AppID=None)

        # Test Activate (required parameter)
        mock_operator_instance.call.reset_mock()
        app_management.Activate(AppID="app456")
        mock_operator_instance.call.assert_called_with("Activate", AppID="app456")

        # Test Deactivate (required parameter)
        mock_operator_instance.call.reset_mock()
        app_management.Deactivate(AppID="app789")
        mock_operator_instance.call.assert_called_with("Deactivate", AppID="app789")

        # Test Uninstall (required parameter)
        mock_operator_instance.call.reset_mock()
        app_management.Uninstall(AppID="app_uninstall")
        mock_operator_instance.call.assert_called_with(
            "Uninstall", AppID="app_uninstall"
        )

        # Test InstallLicense (required License, optional AppID)
        mock_operator_instance.call.reset_mock()
        app_management.InstallLicense(License="LICENSE_KEY_123", AppID="app_license")
        mock_operator_instance.call.assert_called_with(
            "InstallLicense", AppID="app_license", License="LICENSE_KEY_123"
        )

        # Test InstallLicense without AppID
        mock_operator_instance.call.reset_mock()
        app_management.InstallLicense(License="LICENSE_KEY_456")
        mock_operator_instance.call.assert_called_with(
            "InstallLicense", AppID=None, License="LICENSE_KEY_456"
        )

        # Test GetDeviceId (no parameters)
        mock_operator_instance.call.reset_mock()
        app_management.GetDeviceId()
        mock_operator_instance.call.assert_called_with("GetDeviceId")
    ...
    def test_parameter_forwarding(self, mock_operator_class):
        ...
        for test_case in test_cases:
            mock_operator_instance.call.reset_mock()
            method = getattr(app_management, test_case["method"])
