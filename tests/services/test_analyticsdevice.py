...
class TestAnalyticsDeviceWSDLCompliance:
    ...
    def get_wsdl_operations():
        ...
        port_type = root.find('.//wsdl:portType[@name="AnalyticsDevicePort"]', ns)
    ...
    def get_implemented_methods():
        """Get all implemented methods in AnalyticsDevice class."""
        methods = {}
        for name, method in inspect.getmembers(
            AnalyticsDevice, predicate=inspect.isfunction
        ):
    ...
    @patch("onvif.services.analyticsdevice.ONVIFOperator")
    def test_operator_call_usage(self, mock_operator_class):
        ...
        # Create AnalyticsDevice instance
        analytics_device = AnalyticsDevice(xaddr="http://test:80/onvif/AnalyticsDevice")
        ...
        for method_name, method_info in implemented_methods.items():
            ...
            try:
                # Get the method
                method = getattr(analytics_device, method_name)
    ...
    def test_specific_methods_implementation(self, mock_operator_class):
        ...
        analytics_device.GetServiceCapabilities()
        mock_operator_instance.call.assert_called_with("GetServiceCapabilities")

        # Test GetAnalyticsEngines (no parameters)
        mock_operator_instance.call.reset_mock()
        analytics_device.GetAnalyticsEngines()
        mock_operator_instance.call.assert_called_with("GetAnalyticsEngines")

        # Test GetAnalyticsEngine (required parameter)
        mock_operator_instance.call.reset_mock()
        analytics_device.GetAnalyticsEngine(ConfigurationToken="token123")
        mock_operator_instance.call.assert_called_with(
            "GetAnalyticsEngine", ConfigurationToken="token123"
        )

        # Test GetAnalyticsEngineControls (no parameters)
        mock_operator_instance.call.reset_mock()
        analytics_device.GetAnalyticsEngineControls()
        mock_operator_instance.call.assert_called_with("GetAnalyticsEngineControls")

        # Test GetAnalyticsEngineControl (required parameter)
        mock_operator_instance.call.reset_mock()
        analytics_device.GetAnalyticsEngineControl(ConfigurationToken="token456")
        mock_operator_instance.call.assert_called_with(
            "GetAnalyticsEngineControl", ConfigurationToken="token456"
        )

        # Test CreateAnalyticsEngineControl (required parameter)
        mock_operator_instance.call.reset_mock()
        analytics_device.CreateAnalyticsEngineControl(
            Configuration={"Token": "config1", "Name": "Control1"}
        )
        mock_operator_instance.call.assert_called_with(
        ...
        # Test DeleteAnalyticsEngineControl (required parameter)
        mock_operator_instance.call.reset_mock()
        analytics_device.DeleteAnalyticsEngineControl(ConfigurationToken="token789")
        mock_operator_instance.call.assert_called_with(
            "DeleteAnalyticsEngineControl", ConfigurationToken="token789"
        )

        # Test SetAnalyticsEngineControl (multiple required parameters)
        mock_operator_instance.call.reset_mock()
        analytics_device.SetAnalyticsEngineControl(
            SetAnalyticsEngineControl={"Token": "control1"}, ForcePersistence=True
        )
        mock_operator_instance.call.assert_called_with(
        ...
        # Test GetVideoAnalyticsConfiguration (required parameter)
        mock_operator_instance.call.reset_mock()
        analytics_device.GetVideoAnalyticsConfiguration(ConfigurationToken="va_token")
        mock_operator_instance.call.assert_called_with(
            "GetVideoAnalyticsConfiguration", ConfigurationToken="va_token"
        )

        # Test SetVideoAnalyticsConfiguration (multiple required parameters)
        mock_operator_instance.call.reset_mock()
        analytics_device.SetVideoAnalyticsConfiguration(
            Configuration={"Token": "va1", "Name": "Config"}, ForcePersistence=False
        )
        mock_operator_instance.call.assert_called_with(
        ...
        # Test GetAnalyticsEngineInputs (no parameters)
        mock_operator_instance.call.reset_mock()
        analytics_device.GetAnalyticsEngineInputs()
        mock_operator_instance.call.assert_called_with("GetAnalyticsEngineInputs")

        # Test GetAnalyticsDeviceStreamUri (multiple required parameters)
        mock_operator_instance.call.reset_mock()
        analytics_device.GetAnalyticsDeviceStreamUri(
            StreamSetup={"Stream": "RTP-Unicast"}, AnalyticsEngineControlToken="aec123"
        )
        mock_operator_instance.call.assert_called_with(
        ...
        # Test GetAnalyticsState (required parameter)
        mock_operator_instance.call.reset_mock()
        analytics_device.GetAnalyticsState(AnalyticsEngineControlToken="state123")
        mock_operator_instance.call.assert_called_with(
            "GetAnalyticsState", AnalyticsEngineControlToken="state123"
        )
    ...
    def test_parameter_forwarding(self, mock_operator_class):
        ...
        for test_case in test_cases:
            mock_operator_instance.call.reset_mock()
            method = getattr(analytics_device, test_case["method"])
